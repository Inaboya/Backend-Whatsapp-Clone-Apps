...
exports.getGroupInfo = exports.otherUserProfile = exports.signup = void 0;
...
const otherUserProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const otherUser = yield Users_1.UserAuth.findById(userId);
...
const getGroupInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const group = yield GroupModel_1.Group.findById({ _id: groupId });
